...
public class Part2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String activationFunction = args[4];
        Layer actFunc = null;

        if (activationFunction.equals("TanH")) {
            actFunc = new TanH();
            //System.out.println("\nTanH is being used as the activation function!\n");
        } else if (activationFunction.equals("ReLU")) {
            actFunc = new ReLU();
            //System.out.println("\nReLU is being used as the activation function!\n");
        } else {
            //System.out.println("Please use either TanH or ReLU as the fourth argument.\n");
            return;
        }
